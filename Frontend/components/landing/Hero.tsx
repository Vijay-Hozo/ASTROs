    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-12 text-center">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.18 }} className="flex items-center justify-center gap-4">
          <button className="px-6 py-3 rounded-md bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg hover:scale-[1.02] transition">Try Rule Engine</button>
          <button className="px-5 py-3 rounded-md bg-white border border-border text-textDarkBlue hover:shadow-md transition">View Demo</button>
        </motion.div>
      </div>
    </section>
  );
